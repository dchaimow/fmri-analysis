...
if __name__ == "__main__":
    ...
    parser.add_argument('inv2', type=str,
                        help='path to nifti file containing MP2RAGE INV2 data')
    parser.add_argument('uni', type=str,
                        help='path to nifti file containing MP2RAGE UNI data')
    parser.add_argument('--fs_dir', type=str,
                        help='path to output fs dir')
    parser.add_argument('--spm_dir', type=str,
                        help='path to spm installation')
    parser.add_argument('--gdc_coeff_file',
    ...
    anatomy.mp2rage_recon_all(args.inv2, args.uni,
